...
class ElectronDownloader {
  ...
  get arch () {
    return this.opts.arch || hostArch()
  }
...
module.exports.hostArch = hostArch
module.exports.platformArches = {
  darwin: ['x64'],
  // deliberately not adding 'arm' because it's the same as armv7l
  linux: ['armv7l', 'ia32', 'x64'],
  mas: ['x64'],
  win32: ['ia32', 'x64']
}
